...
<!--               <button><a href="Nomer/form.php">Забронировать</a></button>-->
                ...
                <?php if (!empty($_SESSION['id_user'])): $klient = $klient->findKlient($_SESSION['id_user']) ?>
                    <?= $klient['first_name'] . ' ' . $klient['last_name'] ?>
                    <form action="logout.php" method="post">
                        <button type="submit">Выход</button>
                    </form>
                <?php else: ?>
                    <a style="cursor: pointer" href="login.php"><button>Войти</button></a>
                    <a style="cursor: pointer" href=""><button>Регистрация</button></a>
                <?php endif; ?>
    ...
    <section class="agents" id="nomera">
        <div class="wrapper">
            ...
            <div class="agent-cards">
                <?php $n = 0; foreach ($nomera as $value): $n++; ?>
                    <?php if ($n > 3): ?>
                        </div>
                        <div class="agent-cards">
